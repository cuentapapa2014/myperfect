...
function agregar(e) {
    if (compruebaCampos()) {
        if (confirm("¿Seguro que quieres insertar este usuario?")) {
...
function editar(e) {
    if (confirm("¿Seguro que quieres editar a " + formulario[1].value + " " + formulario[2].value)) {
        var formulario = document.getElementById('formulario');
...
function borrar(e) {
    var formulario = document.getElementById('formulario');
    if (confirm("¿Seguro que quieres eliminar a " + formulario[1].value + " " + formulario[2].value)) {
...
function editarBorrar(b1, b2, elemento) {
    ...
    formulario[2].value = elemento.children[3].textContent;
    formulario[3].value = elemento.children[4].textContent;
    formulario[4].value = elemento.children[5].textContent;
    formulario[5].value = elemento.children[0].textContent;
}
